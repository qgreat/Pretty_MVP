...
import com.codingqi.pretty.mvp.ui.adapter.UserAdapter;
...
/**
 * Time：2017/3/25 下午4:48
 * @author Yachao Qi
 * File Name： UserPresenter.java
 * Explain：
 */
@ActivityScope
public class UserPresenter extends BasePresenter<UserContract.Model, UserContract.View> {
    ...
    public void requestUsers(final boolean pullToRefresh) {
        ...
        if (pullToRefresh) lastUserId =lastUserId + 1;//上拉刷新默认只请求第一页

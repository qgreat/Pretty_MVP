...
public class ServiceManager implements BaseServiceManager {
     ...
     * @param commonService
     */
    @Inject public ServiceManager(CommonService commonService,UserService userService,GirlService girlService){
    ...
    public  GirlService getGirlService() {return  girlService;}
